    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="text" id="uri" value="{{$row->uri}}">
                <code>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var methods = {!! json_encode($row->methods) !!};
        $('#methods').selectpicker('val', methods);
    });
</script>
...
?>
{!! Setting::autoSave($saveParam,url(route('develop.permission.edit.submit')),true) !!}
